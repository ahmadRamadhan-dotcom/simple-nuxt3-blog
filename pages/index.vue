<template>
  <div class="home">
    ...
    <main>
      <Hero />
      <div
        class="mt-16 grid place-content-center place-items-center lg:place-items-start gap-8 lg:gap-16 xl:gap-24"
      >
        <div
        ...
        >
          <NuxtLink :to="data._path">
            ...
            <p
              ...
              :class="
                index == 0
                  ? 'block md:hidden text-4xl lg:text-4xl'
                  : 'text-[30px]'
              "
          ...
          <div
            v-if="index == 0"
            class="md:grid md:grid-cols-2 md:gap-10 md:mt-10"
          >
            <div class="">
              <p
                id="title"
